...
// Filtrer les fichiers contenant '_pieces' dans leur nom
$piecesFiles = array_filter($csvFiles, function($file) {
...
$date = date('Ymd');
$fileCount = count($piecesFiles);
$fileName = "{$date}_Norm_{$totalInterventions}_pieces_pour_{$fileCount}_utilisateur.csv";
...
// Ajouter le BOM UTF-8 pour signaler à Excel que c'est du UTF-8
